...
class NeMoGuardrailsStub(object):
...
class NeMoGuardrailsServicer(object):
    """Missing associated documentation comment in .proto file."""

    def Verify(self, request, context):
        """Validates input or output text against configured rails
        """
...
def add_NeMoGuardrailsServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'governance.NeMoGuardrails', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('governance.NeMoGuardrails', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class NeMoGuardrails(object):
    """Missing associated documentation comment in .proto file."""
