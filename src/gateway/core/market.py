...
class MarketService:
    def __init__(self):
        ...
        # Bolt Optimization: Reusing httpx clients for connection pooling (TCP/SSL handshake reuse).
        # This significantly improves performance for repeated requests.
        self.async_client = httpx.AsyncClient()
        self.sync_client = httpx.Client()

    async def shutdown(self):
        """Close persistent async connections."""
        await self.async_client.aclose()

    def shutdown_sync(self):
        """Close persistent sync connections."""
