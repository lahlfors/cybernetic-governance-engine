# Green Agent Subsystem (Layer 4: Verification)

The **Green Agent** is the "Proctor" of the system. It is strictly separated from the runtime "Purple Agent" (Financial Coordinator). Its job is to Audit, Simulate, and Grade.

## Components

### 1. The Auditor (`auditor.py`)
The **GreenAuditor** implements a "Neuro-Symbolic" evaluation approach suitable for Vertex AI Rapid Evaluation.
...
result = green_auditor.audit_trace(trace_data)
...
4.  **Grading:** The Green Agent audits the interaction.
