...
1. Parse the user's intent to identify the symbol, amount, and currency.
2. CALL the 'execute_trade' tool with the correct parameters.
3. If the tool returns 'BLOCKED', explain the policy violation to the user clearly (e.g., "The trade was blocked because the amount exceeds the limit of 1M").
4. If the tool returns 'SUCCESS', confirm the trade details to the user.
"""
